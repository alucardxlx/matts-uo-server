	...
	public class CharacterCreation
	{
		...
		private static void EventSink_CharacterCreated( CharacterCreatedEventArgs args )
		{
			...
			if ( young )
			{
				...
				//newChar.BankBox.DropItem( new BagOfReagents( 5000 ) ); //MattChange - add resources for testing
				newChar.BankBox.DropItem( new BankCheck( 500000 ) );
			}
		...
		private static readonly CityInfo m_NewHavenInfo = new CityInfo( "Britain", "Sweet Dreams Inn", 1495, 1629, 10, Map.Felucca );
